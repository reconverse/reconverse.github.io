...
```
[incidence2](https://www.repidemicsconsortium.org/incidence2/) Provides functions and
...
cat("![](images/badge-maturing.svg)\n")
```
[i2extras](https://www.repidemicsconsortium.org/i2extras/) Provides additional
functionality to the [incidence2](https://www.repidemicsconsortium.org/incidence2/)
...
cat("![](images/badge-maturing.svg)\n")
```
[trending](https://www.repidemicsconsortium.org/trending/) provides a coherent interface
...
```
[trendeval](https://www.repidemicsconsortium.org/trendeval/) provides an interface for
evaluating models fit with the [trending](https://www.repidemicsconsortium.org/trending/)
package.
